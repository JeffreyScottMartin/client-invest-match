...
const AddressCard = (props) => {
  return (
    <div className="w-full lg:w-[90%] mx-auto lg:p-4">
      <div className="bg-white pb-12 pt-12 shadow-md p-6 mt-8 mb-4 flex items-start flex-col xl:flex-row space-y-4 sm:space-y-0 sm:space-x-4 items-center">
        <div className="basis-2/3 justify-center text-center object-center sm:ml-4">
          <Image
            ...
            alt="InvestMatch"
            loading="lazy"
            className="object-center items-center m-0 lg:m-8"
          />
        </div>
